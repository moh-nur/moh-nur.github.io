...
const Vt = b("h2", {
        class: "text-5xl font-semibold text-gray-600 mb-8"
    }, " Experience ", -1),
    $t = {
...
var en = w({
    ...
    setup: e => (e, t) => {
        const n = Nt;
        return _(), y("div", null, [Vt, b("div", $t, [b("div", null, [Bt, b("div", Yt, [b(n, {
            title: "Lorem Ipsum",
            company: "Sit Amet",
            "start-date": new Date("2016"),
            "end-date": new Date("2018")
        }, {
            default: z((() => [qt])),
            _: 1
        }, 8, ["start-date", "end-date"]), b(n, {
            title: "Lorem Ipsum",
            company: "Sit Amet",
            "start-date": new Date("2016"),
            "end-date": new Date("2018")
            ...
            default: z((() => [Gt])),
            _: 1
        }, 8, ["start-date", "end-date"])])]), b("div", null, [Jt, b("div", Kt, [b(n, {
            title: "Lorem Ipsum",
            company: "Sit Amet",
            "start-date": new Date("2016"),
            "end-date": new Date("2018")
...
const tn = {
    ...
    rn = {
        class: "text-2xl dark:text-gray-300 text-gray-600 font-semibold"
    },
    an = {
        class: "flex flex-row space-x-2 text-opacity-60"
    },
    on = {
        class: "prose flex-1 dark:text-white dark:text-opacity-50"
    };
var ln = w({
    expose: [],
    props: {
    ...
    setup: e => (t, n) => (_(), y("div", tn, [b("div", nn, [b("header", rn, k(e.title), 1), b("div", an, [(_(!0), y(g, null, M(e.tags, (e => (_(), y("div", {
        key: e,
        class: "text-xs border rounded dark:border-gray-700 px-2 py-1"
    }, k(e), 1)))), 128))]), b("img", {
        src: e.image,
        class: "block lg:hidden flex-grow-0 flex-shrink-1 mb-4 shadow-lg bg-black bg-opacity-10 dark:bg-black dark:bg-opacity-50 p-8 rounded"
    }, null, 8, ["src"]), b("div", on, [x(t.$slots, "default")])]), b("img", {
        src: e.image,
        class: "hidden lg:block flex-grow-0 flex-shrink-1 w-72 shadow-lg bg-black bg-opacity-10 dark:bg-black dark:bg-opacity-50 p-8 rounded"
    }, null, 8, ["src"])]))
});
const sn = b("h2", {
        class: "text-5xl font-semibold text-gray-600 mb-8"
...
var mn = w({
    ...
    setup: e => (e, t) => {
        const n = ln;
        return _(), y("div", null, [sn, b("div", cn, [b(n, {
            title: "Somtrust",
            tags: ["React", "NodeJS"],
            image: "/somtrust-logo.png"
        }, {
            default: z((() => [un])),
            _: 1
        })])])
...
const dn = {
    ...
    fn = {
        class: "grid lg:grid-cols-2 items-center gap-4",
        style: {
    ...
    bn = b("div", {
        ...
        class: "relative z-5 pl-10 font-semibold text-black max-w-72"
    }, [b("span", {
        class: "text-3xl block"
    }, " Code Crimson "), b("span", {
        class: "text-md"
    }, [S(" Software Development"), b("br"), S(" by Mohamed Nur ")])]), b("svg", {
        class: "absolute fill-red-600 max-w-125",
        viewBox: "0 0 200 200",
        xmlns: "http://www.w3.org/2000/svg"
    }, [b("path", {
        d: "M17.7,-33.4C26.7,-25.4,40.6,-28.4,53.9,-24.7C67.1,-21,79.8,-10.5,81.4,0.9C83.1,12.4,73.7,24.7,63.5,33.9C53.4,43,42.5,48.9,31.8,49.8C21.1,50.6,10.6,46.4,-2.9,51.4C-16.3,56.3,-32.6,70.4,-39.2,67.2C-45.8,64,-42.8,43.5,-43.6,29.4C-44.5,15.3,-49.2,7.6,-56.1,-4C-63,-15.6,-72.1,-31.2,-69.9,-43C-67.7,-54.8,-54.3,-62.8,-40.8,-68.3C-27.3,-73.7,-13.6,-76.7,-4.7,-68.6C4.3,-60.5,8.6,-41.4,17.7,-33.4Z",
